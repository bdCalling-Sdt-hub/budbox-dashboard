    ...
    return (
        <section className="w-full px-3">
            ...
            <CustomForm onSubmit={submit}>
                ...
                />
                <div>
                    <label htmlFor="categoryImage">Upload Image <span className="text-rose-500 ">*</span></label>
                ...
                <button type='submit' className='w-full bg-[#edf2f4]  text-[#4c7e95] py-2 px-4 border border-[#4c7e95] hover:bg-[#4c7e95] hover:text-white transition-all duration-300 mt-5'>Add Category</button>
